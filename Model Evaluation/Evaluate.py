...
explanation = explainer.explain_instance(instance, pipeline.predict, num_features=len(X_train.columns))
...
for _ in range(n_bootstraps):
    ...
    bootstrap_results.append(mse)

mean_mse = np.mean(bootstrap_results)
std_mse = np.std(bootstrap_results)
confidence_interval = np.percentile(bootstrap_results, [2.5, 97.5])

print("Mean MSE:", mean_mse)
print("Standard Deviation of MSE:", std_mse)
print("95% Confidence Interval of MSE:", confidence_interval)
